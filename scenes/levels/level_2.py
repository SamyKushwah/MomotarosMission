...
def create_level(my_toolbox):
    ...
    level2.add_obstacle(4900, 500, "button", fence_initial=(3375, 200), fence_final=(3375, -60), fence_dimensions=(150, 400))     # third top gate
    level2.add_obstacle(3650, 1000, "button", fence_initial=(4675, 300), fence_final=(4675, -60), fence_dimensions=(150, 400))    # fourth top gate
    ...
    level2.add_obstacle(3750, 1000, "button", fence_initial=(3925, 778), fence_final=(3925, 330), fence_dimensions=(150, 465))    # second bottom gate
