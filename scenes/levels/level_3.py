...
def create_level(my_toolbox):
    ...
    level3.add_platform((500, 1080 - 69), (150, 70))                                            # bottom wall section 1
    level3.add_platform((850, 1080 - 69), (150, 70))
    #level3.add_platform((1000, 1080 - 69), (200, 70))                                           # bottom wall section 3
    level3.add_platform((1200, 1080 - 69), (2500, 70))                                           # bottom wall section 3
    level3.add_platform((4300, 1080 - 69), (750, 70))                                           # bottom wall section 4
    # 3030
    ...
    level3.add_platform((2000, 70), (50, 450 + 50 + 330 + 50), facing_direction=None)
    ...
    # add water sections
    level3.add_platform((300, 1100 - 70), (200, 70), platform_type="water")  # water section 1 (bottom)
    level3.add_platform((650, 1100 - 70), (200, 70), platform_type="water")  # water section 2 (bottom)
    level3.add_platform((1000, 1100 - 70), (200, 70), platform_type="water")
