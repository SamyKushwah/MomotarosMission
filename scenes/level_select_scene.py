...
def run(my_toolbox: toolbox.Toolbox):
    ...
    button_1_img = pygame.image.load("images/level_select_scene_UI/circle1.png")
    button_1_img = pygame.transform.scale(button_1_img, (h / 4, h / 4))
    button_1 = button.Button(button_1_img)

    button_2_img = pygame.image.load("images/level_select_scene_UI/circle2.png")
    button_2_img = pygame.transform.scale(button_2_img, (h / 4, h / 4))
    button_2 = button.Button(button_2_img)

    button_3_img = pygame.image.load("images/level_select_scene_UI/circle3.png")
    ...
    credits_img = pygame.image.load("images/level_select_scene_UI/credits.png")
    ...
    while running:
        ...
        button_1.draw(scene_screen, (w * (1.5 / 7), h * (4 / 5)))
        button_2.draw(scene_screen, (w * (3.5 / 7), h * (7 / 10)))
        button_3.draw(scene_screen, (w * (5.5 / 7), h * (7 / 9)))
        credits_btn.draw(scene_screen, (w * (91 / 100), h * (97 / 100)))
