...
class ButtonObstacle:
    def __init__(self, button_position, fence_int_position, fence_final_position):
        ...
        self.pushed = False
        self.velocity = (self.fence.initial[1] - self.fence.target[1])/abs(self.fence.initial[1] - self.fence.target[1])
        self.type = "button"
