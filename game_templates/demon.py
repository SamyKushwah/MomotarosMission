...
class Demon:
    ...
    def draw(self, surface):
        ...
        surface.blit(pygame.transform.scale(self.health_bar, (self.health_bar.get_width() * self.health / 100, self.health_bar.get_height())), (self.position[0] - (self.health_holder.get_width()/2) + (self.active_image.get_width()/2), self.position[1] - 30))
        surface.blit(self.health_holder, (self.position[0] - (self.health_holder.get_width()/2) + (self.active_image.get_width()/2), self.position[1] - 30))
