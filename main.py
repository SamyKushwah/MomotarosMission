...
import toolbox
import game_manager
from scenes import level_select_scene, title_menu_scene, pause_screen

my_toolbox = toolbox.Toolbox()

next_state = "title_menu"

os.chdir("/mnt/c/Users/samyk/Documents/MomoShawn/MomotarosMission")
...
while running:
    ...
    match next_state:
        ...
        case "pause":
            ...
            next_state = pause_screen.run(my_toolbox)
